...
---
## IX. Реактивное программирование
---

**Максимальное время выполнения блока - 6 дней**
...
+ [RxSwift в действии](https://habrahabr.ru/post/276971/)  **(\*\*\*)**
+ Getting Started With RxSwift and RxCocoa. [Туториал](https://www.raywenderlich.com/138547/getting-started-with-rxswift-and-rxcocoa)  **(\*\*\*)**
...
Все изменения должны быть закоммичены, а названия коммитов должны коротко и исчерпывающе описывать содержащие изменения. Каждый коммит должен быть рабочим, отправка некомпилирующегося кода недопустима. Для работы над этим заданием необходимо переключится на ветку `rx_swift` и все изменения пушить в нее. После завершения работы над задачей в gitlab необходимо создать merge request в ветку `dev`.
Код должен быть читабельным и написан согласно code-style. В системе Jira также необходимо создать задачу в эпике со своим именем, в которую после завершения будет залогировано время.

1. Создать в эпике сабтаск с типом "Mobile" с названием "IX. Реактивное программирование" и взять ее в работу.
2. Клонировать [проект](http://gitlab.simbirsoft/internships/mobile/ios_rxtraining) и реализовать все методы так, чтобы тесты проходили. Все методы должны быть реализованы в указанном репозитории в отдельной ветке, вида training/lastname_firstname_date. После выполнения должен быть создан merge request на ментора.
3. Создать экран Авторизации согласно [макету](https://zpl.io/Vq6Y67m).
4. Подключить фреймворк `RxSwift`. Реализовать логику работы приложения макисмально используя принципы реактивного программирования.
5. Запустить статические анализаторы кода (SwiftLint) и исправить найденные замечания
6. После завершения работ над заданием перевести задачу в Jira в статус "Code Review", уведомить своего ментора и залогировать затраченное время.

---
## X. Практика в рамках продуктового проекта.
---

**Максимальное время выполнения блока - 8 дней**
...
**1. MVC:**
+ [Концепция Apple](https://developer.apple.com/library/content/documentation/General/Conceptual/DevPedia-CocoaCore/MVC.html)  **(\*\*\*)**

**2. MVP:**
+ [MVP](https://habrahabr.ru/post/323764/)  **(\*\*\)**

**3. MVVM:**
+ [MVVM in iOS](https://medium.com/@azamsharp/mvvm-in-ios-from-net-perspective-580eb7f4f129)  **(\*\*\*)**
+ [Как применять MVVM в iOS](https://stfalcon.com/ru/blog/post/beyond-mvc-how-to-use-MVVM-in-iOS) **(\*\*\*)**

**4. VIPER:**
+ [Введение в VIPER](https://habrahabr.ru/post/273061/)  **(\*\*\)**

### Практическое задание

1. Создать в эпике сабтаск с типом "Mobile" с названием "X. Практика в рамках продуктового проекта" и взять ее в работу.
2. Выполнить задачи по приложению "NextEDU" согласно описанию в [репозитории](http://gitlab.simbirsoft/internships/mobile/ios_trainee_education_dailypower).
...
+ [Вопросы, задаваемые на собеседованиях](https://docs.google.com/document/d/1IfQOMy63QwKBMSzT1PF80Tyx47wp-jyCqIOwAPctoas/edit?usp=sharing) **(\*\*)**
...
+ [MBLTDEV](https://digest.mbltdev.ru/) **(\*\*\*)**
